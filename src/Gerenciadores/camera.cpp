// #include "Gerenciadores/camera.h"
...
//     : limiteCamera(sf::IntRect(-1, -1, -1, -1)),
//       tamJanela(tamJanela),
//       camera(sf::Vector2f(tamJanela.x / 2.0f, tamJanela.y / 2.0f),
//       tamJanela), limiteObjeto(sf::IntRect(-1, -1, -1, -1)) {}
...
// sf::View Camera::getCamera() { return camera; }
...
//     } else if (limiteObjeto.top + limiteObjeto.height >
//                limiteCamera.top + limiteCamera.height) {
//       const float dy = limiteObjeto.top + limiteObjeto.height -
//                        (limiteCamera.top + limiteCamera.height);
//       limiteObjeto.top = limiteObjeto.top - dy;
//     }
//     if (limiteObjeto.left < limiteCamera.left) {
//       limiteObjeto.left = limiteCamera.left;
//     } else if (limiteObjeto.left + limiteObjeto.width >
//                limiteCamera.left + limiteCamera.width) {
//       const float dx = limiteObjeto.left + limiteObjeto.width -
//                        (limiteCamera.left + limiteCamera.width);
//       limiteObjeto.left = limiteObjeto.left - dx;
//     }
//     camera.setCenter(
//         sf::Vector2f(limiteObjeto.left + limiteObjeto.width / 2.0f,
//                      limiteObjeto.top + limiteObjeto.height / 2.0f));
//   }
// }
...
// void Camera::atualizar(const sf::Vector2f pos) { camera.setCenter(pos); }
...
//       limiteObjeto.left + limiteObjeto.width <
//           limiteCamera.left + limiteCamera.width) {
...
//       limiteObjeto.top + limiteObjeto.height <
//           limiteCamera.top + limiteCamera.height) {
