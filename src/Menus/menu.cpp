    ...
    */
    Menu::Menu()
    {
            ...
            if (!font.loadFromFile("assets/Fontes/DejaVuSans-Bold.ttf")) {
                std::cerr << "Erro: Não foi possível carregar a fonte no Windows!" << std::endl;
            }
        #elif __linux__
            // Caminho para Linux
            if (!font.loadFromFile("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf")) {
                std::cerr << "Erro: Não foi possível carregar a fonte no Linux!" << std::endl;
            }
        #endif
        ...
        for (size_t i = 0; i < fases.size(); ++i) {
            ...
            texto.setFillColor(Color::White); // Inicialmente todas as fases são brancas
    ...
    void Menu::selecionaCima(){
        cout << "Menu: Selecionado para Cima" << endl;

    }

    void Menu::selecionaBaixo(){
        cout << "Menu: Selecionado para Baixo" << endl;
    ...
    void Menu::atualizarPosicaoFundo(){
        cout << "Menu: Atualizar Fundo" << endl;
