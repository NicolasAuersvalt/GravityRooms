...
class Item
{
  public:
    ...
    json toJson() const { return {{"nome", nome}, {"quantidade", quantidade}}; }
...
int main()
{
    ...
    {
        std::cout << "Nenhum arquivo de salvamento encontrado. Iniciando do "
                     "início.\n";
    }
            ...
            if (event.type == sf::Event::KeyPressed)
            {
                if (event.key.code == sf::Keyboard::Escape)
                {
                    ...
                    if (pausado)
                    {
                        ...
                        std::thread t(salvarJogador, std::ref(jogador),
                                      arquivoSalvamento);
