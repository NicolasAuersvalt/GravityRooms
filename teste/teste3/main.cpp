...
public:
  ...
  void fecharArquivo() override { cout << "Fechando arquivo JSON." << endl; }

  virtual void parseJson() { cout << "Parsing JSON data..." << endl; }
...
int main() {
  ...
  vector<string> dados = {"Jogador1: 1000 pontos", "Jogador2: 950 pontos",
                          "Jogador3: 900 pontos"};
